...
const enrollmentlinkds = require('../Models/enrollmentlinkds');
...
exports.getenrollmentlinksbycreator = async (req, res) => {
  try {
...
exports.resolveenrollmenttoken = async (req, res) => {
  try {
...
exports.revokeenrollmentlink = async (req, res) => {
  try {
    const { token } = req.params;
