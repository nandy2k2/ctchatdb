...
const attendancenew = require('../Models/attendancenewadvance');
...
// Create Class
exports.createclassadvance = async (req, res) => {
    try {
        const {
...
// Get Classes by User
exports.getclassesbyuseradvance = async (req, res) => {
    try {
...
exports.searchusersadvance = async (req, res) => {
    try {
...
exports.enrollstudentadvance = async (req, res) => {
    try {
        const {
            name, user, colid, year, program, programcode, course,
...
exports.getenrolledstudentsadvance = async (req, res) => {
    try {
...
exports.markattendanceadvance = async (req, res) => {
    try {
...
exports.getclassreportaggregateadvance = async (req, res) => {
    try {
...
exports.getattendancesummarybydateadvance = async (req, res) => {
  try {
...
exports.getstudentreportaggregateadvance = async (req, res) => {
    try {
...
exports.getsinglestudentrportadvance = async (req, res) => {
    try {
...
exports.getenrollmentsadvance = async (req, res) => {
    try {
...
exports.updateenrollmentstatusadvance = async (req, res) => {
    try {
        const { id } = req.params;
...
exports.updateclassadvance = async (req, res) => {
  try {
    const { id } = req.params;
...
exports.deleteclassadvance = async (req, res) => {
  try {
    const { id } = req.params;
    const { user, colid } = req.query;
...
exports.getclassreportbycourseadvance = async (req, res) => {
  try {
...
exports.getfacultycoursesadvance = async (req, res) => {
  try {
    const { user, colid } = req.query;
